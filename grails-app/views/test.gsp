...
<head>
    ...
    <link rel="stylesheet" href="${resource(dir:'css',file:'demos.css')}" type="text/css" media="screen"/>
...
<div class="demo">
    ...
    <div class="ui-widget">
        <label for="combobox">Only these families</label>
        <g:select name="combobox" from="['Brachaeluridae','Carcharhinidae','Dasyatidae']" noSelection="['':'any']"/>
